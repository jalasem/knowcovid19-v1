export default {
  ...
  statesData: [
    { state: 'Lagos', total: 66622, recovered: 58529, death: 465 },
    { state: 'FCT', total: 20121, recovered: 19778, death: 170 },
    { state: 'Kano', total: 4033, recovered: 3914, death: 110 },
    { state: 'Ogun', total: 4963, recovered: 4691, death: 61 },
    { state: 'Osun', total: 2636, recovered: 2541, death: 55 },
    { state: 'Gombe', total: 2118, recovered: 2069, death: 44 },
    { state: 'Borno', total: 1344, recovered: 1305, death: 38 },
    { state: 'Katsina', total: 2114, recovered: 2055, death: 34 },
    { state: 'Edo', total: 4975, recovered: 4760, death: 185 },
    { state: 'Oyo', total: 7400, recovered: 6849, death: 144 },
    { state: 'Bauchi', total: 1549, recovered: 1532, death: 17 },
    { state: 'Kwara', total: 3290, recovered: 3068, death: 55 },
    { state: 'Akwa Ibom', total: 3174, recovered: 2383, death: 32 },
    { state: 'Kaduna', total: 9194, recovered: 9091, death: 66 },
    { state: 'Ekiti', total: 1060, recovered: 909, death: 13 },
    { state: 'Taraba', total: 1001, recovered: 977, death: 24 },
    { state: 'Delta', total: 2712, recovered: 2556, death: 73 },
    { state: 'Ondo', total: 3648, recovered: 3475, death: 68 },
    { state: 'Rivers', total: 8214, recovered: 7521, death: 102 },
    { state: 'Enugu', total: 2484, recovered: 2435, death: 29 },
    { state: 'Niger', total: 935, recovered: 913, death: 17 },
    { state: 'Jigawa', total: 538, recovered: 512, death: 16 },
    { state: 'Zamfara', total: 251, recovered: 236, death: 8 },
    { state: 'Sokoto', total: 775, recovered: 747, death: 28 },
    { state: 'Abia', total: 1693, recovered: 1673, death: 20 },
    { state: 'Ebonyi', total: 2039, recovered: 2002, death: 32 },
    { state: 'Benue', total: 1366, recovered: 1327, death: 24 },
    { state: 'Anambra', total: 1909, recovered: 1826, death: 19 },
    { state: 'Plateau', total: 9122, recovered: 9021, death: 57 },
    { state: 'Adamawa', total: 1134, recovered: 1098, death: 32 },
    { state: 'Imo', total: 1661, recovered: 1624, death: 37 },
    { state: 'Yobe', total: 499, recovered: 490, death: 9 },
    { state: 'Nassarawa', total: 2385, recovered: 2345, death: 39 },
    { state: 'Kebbi', total: 450, recovered: 392, death: 15 },
    { state: 'Bayelsa', total: 955, recovered: 916, death: 26 },
    { state: 'Kogi', total: 5, recovered: 3, death: 2 },
    { state: 'cross River', total: 438, recovered: 406, death: 21 }
  ],
  helplines: [
