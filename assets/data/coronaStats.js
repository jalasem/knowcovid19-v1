export default {
  ...
  statesData: [
    { state: 'Lagos', total: 5663, recovered: 902, death: 67 },
    { state: 'FCT', total: 862, recovered: 217, death: 22 },
    { state: 'Kano', total: 985, recovered: 382, death: 46 },
    { state: 'Ogun', total: 329, recovered: 186, death: 10 },
    { state: 'Osun', total: 49, recovered: 35, death: 4 },
    { state: 'Gombe', total: 184, recovered: 127, death: 7 },
    { state: 'Borno', total: 322, recovered: 185, death: 26 },
    { state: 'Katsina', total: 385, recovered: 189, death: 19 },
    { state: 'Edo', total: 364, recovered: 96, death: 19 },
    { state: 'Oyo', total: 334, recovered: 112, death: 7 },
    { state: 'Bauchi', total: 281, recovered: 222, death: 8 },
    { state: 'Kwara', total: 127, recovered: 45, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 14, death: 2 },
    { state: 'Kaduna', total: 335, recovered: 197, death: 10 },
    { state: 'Ekiti', total: 25, recovered: 18, death: 2 },
    { state: 'Taraba', total: 18, recovered: 1, death: 0 },
    { state: 'Delta', total: 116, recovered: 31, death: 8 },
    { state: 'Ondo', total: 38, recovered: 21, death: 4 },
    { state: 'Rivers', total: 308, recovered: 104, death: 18 },
    { state: 'Enugu', total: 30, recovered: 14, death: 0 },
    { state: 'Niger', total: 41, recovered: 17, death: 1 },
    { state: 'Jigawa', total: 282, recovered: 153, death: 5 },
    { state: 'Zamfara', total: 76, recovered: 71, death: 5 },
    { state: 'Sokoto', total: 115, recovered: 97, death: 14 },
    { state: 'Abia', total: 15, recovered: 7, death: 0 },
    { state: 'Ebonyi', total: 80, recovered: 8, death: 0 },
    ...
    { state: 'Imo', total: 47, recovered: 19, death: 0 },
    { state: 'Yobe', total: 52, recovered: 25, death: 7 },
    { state: 'Nassarawa', total: 90, recovered: 31, death: 5 },
