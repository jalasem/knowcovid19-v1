export default {
  ...
  statesData: [
    ...
    { state: 'FCT', total: 5758, recovered: 4998, death: 78 },
    { state: 'Kano', total: 1738, recovered: 1675, death: 54 },
    { state: 'Ogun', total: 1892, recovered: 1733, death: 28 },
    ...
    { state: 'Katsina', total: 892, recovered: 855, death: 24 },
    ...
    { state: 'Kwara', total: 1045, recovered: 982, death: 25 },
    { state: 'Akwa Ibom', total: 293, recovered: 278, death: 8 },
    { state: 'Kaduna', total: 2446	, recovered: 2356, death: 40 },
    ...
    { state: 'Rivers', total: 2582, recovered: 2378, death: 59 },
    ...
    { state: 'Anambra', total: 245, recovered: 219, death: 19 },
    ...
    { state: 'Nassarawa', total: 455, recovered: 325, death: 13 },
