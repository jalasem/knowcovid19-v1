export default {
  ...
  statesData: [
    { state: 'Lagos', total: 18611, recovered: 15245, death: 204 },
    { state: 'FCT', total: 5447, recovered: 1644, death: 74 },
    { state: 'Kano', total: 1732, recovered: 1626, death: 54 },
    { state: 'Ogun', total: 1739, recovered: 1675, death: 28 },
    { state: 'Osun', total: 804, recovered: 762, death: 17 },
    ...
    { state: 'Oyo', total: 3221, recovered: 2076, death: 39 },
    { state: 'Bauchi', total: 679, recovered: 646, death: 14 },
    { state: 'Kwara', total: 992, recovered: 794, death: 25 },
    { state: 'Akwa Ibom', total: 286, recovered: 251, death: 8 },
    { state: 'Kaduna', total: 2279	, recovered: 2161, death: 32 },
    { state: 'Ekiti', total: 300, recovered: 255, death: 5 },
    { state: 'Taraba', total: 95, recovered: 73, death: 6 },
    { state: 'Delta', total: 1791, recovered: 1629, death: 49 },
    { state: 'Ondo', total: 1584	, recovered: 1490, death: 34 },
    { state: 'Rivers', total: 2207, recovered: 2116, death: 59 },
    ...
    { state: 'Abia', total: 828, recovered: 771, death: 8 },
    { state: 'Ebonyi', total: 1034, recovered: 997, death: 30 },
    { state: 'Benue', total: 467, recovered: 401, death: 9 },
    { state: 'Anambra', total: 231, recovered: 182, death: 19 },
    { state: 'Plateau', total: 3098, recovered: 2010, death: 31 },
    ...
    { state: 'Bayelsa', total: 393, recovered: 367, death: 21 },
