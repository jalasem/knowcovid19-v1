export default {
  ...
  statesData: [
    { state: 'Lagos', total: 6065, recovered: 944, death: 72 },
    { state: 'FCT', total: 1012, recovered: 275, death: 24 },
    { state: 'Kano', total: 1020, recovered: 497, death: 50 },
    { state: 'Ogun', total: 471, recovered: 186, death: 13 },
    { state: 'Osun', total: 50, recovered: 39, death: 4 },
    { state: 'Gombe', total: 246, recovered: 135, death: 10 },
    { state: 'Borno', total: 367, recovered: 205, death: 26 },
    { state: 'Katsina', total: 399, recovered: 209, death: 21 },
    { state: 'Edo', total: 462, recovered: 115, death: 25 },
    { state: 'Oyo', total: 398, recovered: 112, death: 7 },
    { state: 'Bauchi', total: 364, recovered: 224, death: 9 },
    { state: 'Kwara', total: 143, recovered: 63, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 15, death: 2 },
    { state: 'Kaduna', total: 369, recovered: 230, death: 10 },
    { state: 'Ekiti', total: 30, recovered: 18, death: 2 },
    { state: 'Taraba', total: 18, recovered: 10, death: 0 },
    { state: 'Delta', total: 175, recovered: 50, death: 8 },
    { state: 'Ondo', total: 46, recovered: 21, death: 7 },
    { state: 'Rivers', total: 394, recovered: 158, death: 21 },
    { state: 'Enugu', total: 30, recovered: 14, death: 1 },
    { state: 'Niger', total: 46, recovered: 26, death: 1 },
    { state: 'Jigawa', total: 309, recovered: 156, death: 5 },
    { state: 'Zamfara', total: 76, recovered: 71, death: 5 },
    { state: 'Sokoto', total: 129, recovered: 101, death: 14 },
    { state: 'Abia', total: 97, recovered: 7, death: 0 },
    { state: 'Ebonyi', total: 152, recovered: 67, death: 0 },
    { state: 'Benue', total: 13, recovered: 1, death: 0 },
    { state: 'Anambra', total: 46, recovered: 3, death: 1 },
    { state: 'Plateau', total: 128, recovered: 99, death: 3 },
    { state: 'Adamawa', total: 42, recovered: 34, death: 4 },
    { state: 'Imo', total: 83, recovered: 19, death: 0 },
    { state: 'Yobe', total: 52, recovered: 25, death: 7 },
    { state: 'Nassarawa', total: 113, recovered: 31, death: 5 },
    { state: 'Kebbi', total: 41, recovered: 29, death: 4 },
    { state: 'Bayelsa', total: 30, recovered: 17, death: 3 },
