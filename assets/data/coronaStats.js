export default {
  ...
  statesData: [
    { state: 'Lagos', total: 4755, recovered: 766, death: 50 },
    { state: 'FCT', total: 616, recovered: 173, death: 17 },
    { state: 'Kano', total: 951, recovered: 200, death: 43 },
    { state: 'Ogun', total: 259, recovered: 146, death: 9 },
    { state: 'Osun', total: 45, recovered: 35, death: 4 },
    { state: 'Gombe', total: 156, recovered: 122, death: 4 },
    { state: 'Borno', total: 271, recovered: 167, death: 26 },
    { state: 'Katsina', total: 364, recovered: 68, death: 14 },
    { state: 'Edo', total: 284, recovered: 69, death: 13 },
    { state: 'Oyo', total: 280, recovered: 97, death: 6 },
    { state: 'Bauchi', total: 236, recovered: 214, death: 7 },
    { state: 'Kwara', total: 87, recovered: 37, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 14, death: 2 },
    { state: 'Kaduna', total: 244, recovered: 157, death: 7 },
    { state: 'Ekiti', total: 20, recovered: 16, death: 2 },
    { state: 'Taraba', total: 18, recovered: 1, death: 0 },
    { state: 'Delta', total: 80, recovered: 16, death: 7 },
    { state: 'Ondo', total: 25, recovered: 20, death: 2 },
    { state: 'Rivers', total: 204, recovered: 52, death: 13 },
    { state: 'Enugu', total: 18, recovered: 12, death: 0 },
    { state: 'Niger', total: 30, recovered: 9, death: 1 },
    { state: 'Jigawa', total: 270, recovered: 109, death: 5 },
    ...
    { state: 'Plateau', total: 104, recovered: 53, death: 2 },
    { state: 'Adamawa', total: 38, recovered: 20, death: 4 },
    { state: 'Imo', total: 34, recovered: 14, death: 0 },
    ...
    { state: 'Bayelsa', total: 12, recovered: 7, death: 1 },
