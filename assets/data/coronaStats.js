export default {
  ...
  statesData: [
    ...
    { state: 'Ogun', total: 523, recovered: 214, death: 13 },
    { state: 'Osun', total: 50, recovered: 40, death: 4 },
    { state: 'Gombe', total: 293, recovered: 135, death: 12 },
    { state: 'Borno', total: 381, recovered: 205, death: 26 },
    { state: 'Katsina', total: 411, recovered: 219, death: 21 },
    { state: 'Edo', total: 490, recovered: 122, death: 25 },
    { state: 'Oyo', total: 434, recovered: 118, death: 7 },
    { state: 'Bauchi', total: 392, recovered: 230, death: 10 },
    { state: 'Kwara', total: 143, recovered: 70, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 15, death: 2 },
    { state: 'Kaduna', total: 392, recovered: 241, death: 10 },
    { state: 'Ekiti', total: 30, recovered: 18, death: 2 },
    { state: 'Taraba', total: 18, recovered: 10, death: 0 },
    { state: 'Delta', total: 225, recovered: 63, death:11 },
    { state: 'Ondo', total: 54, recovered: 31, death: 9 },
    { state: 'Rivers', total: 454, recovered: 188, death: 22 },
    { state: 'Enugu', total: 35, recovered: 14, death: 1 },
    { state: 'Niger', total: 46, recovered: 26, death: 1 },
    { state: 'Jigawa', total: 314, recovered: 171, death: 5 },
    { state: 'Zamfara', total: 76, recovered: 71, death: 5 },
    { state: 'Sokoto', total: 129, recovered: 103, death: 14 },
    { state: 'Abia', total: 97, recovered: 16, death: 0 },
    { state: 'Ebonyi', total: 152, recovered: 70, death: 0 },
    { state: 'Benue', total: 13, recovered: 1, death: 0 },
    { state: 'Anambra', total: 53, recovered: 13, death: 1 },
    { state: 'Plateau', total: 130, recovered: 99, death: 3 },
    { state: 'Adamawa', total: 42, recovered: 34, death: 4 },
    { state: 'Imo', total: 112, recovered: 19, death: 1 },
    { state: 'Yobe', total: 52, recovered: 25, death: 7 },
    { state: 'Nassarawa', total: 128, recovered: 31, death: 5 },
    { state: 'Kebbi', total: 47, recovered: 29, death: 5 },
