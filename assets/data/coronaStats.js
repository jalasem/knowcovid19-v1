export default {
  ...
  statesData: [
    { state: 'Lagos', total: 4943, recovered: 825, death: 54 },
    { state: 'FCT', total: 660, recovered: 182, death: 19 },
    { state: 'Kano', total: 954, recovered: 240, death: 45 },
    { state: 'Ogun', total: 278, recovered: 149, death: 9 },
    { state: 'Osun', total: 45, recovered: 35, death: 4 },
    { state: 'Gombe', total: 161, recovered: 122, death: 6 },
    { state: 'Borno', total: 271, recovered: 167, death: 26 },
    { state: 'Katsina', total: 364, recovered: 68, death: 14 },
    { state: 'Edo', total: 284, recovered: 81, death: 13 },
    { state: 'Oyo', total: 292, recovered: 97, death: 6 },
    { state: 'Bauchi', total: 238, recovered: 220, death: 8 },
    { state: 'Kwara', total: 88, recovered: 37, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 14, death: 2 },
    { state: 'Kaduna', total: 258, recovered: 157, death: 8 },
    { state: 'Ekiti', total: 20, recovered: 16, death: 2 },
    { state: 'Taraba', total: 18, recovered: 1, death: 0 },
    { state: 'Delta', total: 83, recovered: 17, death: 8 },
    { state: 'Ondo', total: 25, recovered: 20, death: 2 },
    { state: 'Rivers', total: 206, recovered: 59, death: 14 },
    { state: 'Enugu', total: 18, recovered: 12, death: 0 },
    { state: 'Niger', total: 32, recovered: 9, death: 1 },
    { state: 'Jigawa', total: 270, recovered: 135, death: 5 },
    { state: 'Zamfara', total: 76, recovered: 71, death: 5 },
    { state: 'Sokoto', total: 116, recovered: 96, death: 14 },
    { state: 'Abia', total: 10, recovered: 3, death: 0 },
    { state: 'Ebonyi', total: 40, recovered: 8, death: 0 },
    { state: 'Benue', total: 7, recovered: 1, death: 0 },
    { state: 'Anambra', total: 11, recovered: 3, death: 1 },
    { state: 'Plateau', total: 105, recovered: 53, death: 2 },
    { state: 'Adamawa', total: 38, recovered: 20, death: 4 },
    { state: 'Imo', total: 36, recovered: 14, death: 0 },
    ...
    { state: 'Bayelsa', total: 21, recovered: 7, death: 1 },
