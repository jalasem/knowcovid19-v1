export default {
  ...
  statesData: [
    { state: 'Lagos', total: 5135, recovered: 825, death: 55 },
    { state: 'FCT', total: 674, recovered: 200, death: 20 },
    { state: 'Kano', total: 958, recovered: 240, death: 45 },
    { state: 'Ogun', total: 290, recovered: 160, death: 9 },
    { state: 'Osun', total: 45, recovered: 35, death: 4 },
    { state: 'Gombe', total: 161, recovered: 122, death: 6 },
    { state: 'Borno', total: 288, recovered: 168, death: 26 },
    { state: 'Katsina', total: 371, recovered: 99, death: 19 },
    { state: 'Edo', total: 325, recovered: 69, death: 13 },
    { state: 'Oyo', total: 302, recovered: 98, death: 7 },
    { state: 'Bauchi', total: 240, recovered: 221, death: 8 },
    { state: 'Kwara', total: 111, recovered: 37, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 14, death: 2 },
    { state: 'Kaduna', total: 288, recovered: 170, death: 8 },
    { state: 'Ekiti', total: 20, recovered: 16, death: 2 },
    { state: 'Taraba', total: 18, recovered: 1, death: 0 },
    { state: 'Delta', total: 88, recovered: 17, death: 8 },
    { state: 'Ondo', total: 28, recovered: 21, death: 4 },
    { state: 'Rivers', total: 239, recovered: 68, death: 14 },
    { state: 'Enugu', total: 18, recovered: 12, death: 0 },
    { state: 'Niger', total: 33, recovered: 9, death: 1 },
    ...
    { state: 'Benue', total: 9, recovered: 1, death: 0 },
    { state: 'Anambra', total: 11, recovered: 3, death: 1 },
    { state: 'Plateau', total: 105, recovered: 69, death: 2 },
    ...
    { state: 'Nassarawa', total: 80, recovered: 19, death: 3 },
