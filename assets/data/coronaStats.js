export default {
  ...
  statesData: [
    { state: 'Lagos', total: 6611, recovered: 997, death: 82 },
    { state: 'FCT', total: 1097, recovered: 280, death: 25 },
    { state: 'Kano', total: 1048, recovered: 556, death: 50 },
    { state: 'Ogun', total: 544, recovered: 214, death: 14 },
    { state: 'Osun', total: 50, recovered: 40, death: 4 },
    { state: 'Gombe', total: 293, recovered: 135, death: 12 },
    { state: 'Borno', total: 423, recovered: 231, death: 26 },
    { state: 'Katsina', total: 411, recovered: 219, death: 21 },
    { state: 'Edo', total: 518, recovered: 128, death: 25 },
    { state: 'Oyo', total: 469, recovered: 216, death: 7 },
    { state: 'Bauchi', total: 402, recovered: 230, death: 10 },
    { state: 'Kwara', total: 149, recovered: 70, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 15, death: 2 },
    { state: 'Kaduna', total: 402, recovered: 242, death: 10 },
    { state: 'Ekiti', total: 30, recovered: 18, death: 2 },
    { state: 'Taraba', total: 18, recovered: 10, death: 0 },
    { state: 'Delta', total: 243, recovered: 63, death:11 },
    { state: 'Ondo', total: 62, recovered: 32, death: 9 },
    { state: 'Rivers', total: 454, recovered: 188, death: 22 },
    { state: 'Enugu', total: 39, recovered: 14, death: 1 },
    { state: 'Niger', total: 49, recovered: 28, death: 1 },
    ...
    { state: 'Abia', total: 151, recovered: 16, death: 0 },
    { state: 'Ebonyi', total: 152, recovered: 70, death: 0 },
    { state: 'Benue', total: 13, recovered: 1, death: 0 },
    { state: 'Anambra', total: 53, recovered: 18, death: 9 },
    { state: 'Plateau', total: 148, recovered: 99, death: 3 },
    { state: 'Adamawa', total: 42, recovered: 34, death: 4 },
    { state: 'Imo', total: 114, recovered: 19, death: 1 },
    { state: 'Yobe', total: 52, recovered: 25, death: 7 },
    { state: 'Nassarawa', total: 132, recovered: 64, death: 6 },
    { state: 'Kebbi', total: 50, recovered: 29, death: 5 },
    { state: 'Bayelsa', total: 32, recovered: 20, death: 3 },
