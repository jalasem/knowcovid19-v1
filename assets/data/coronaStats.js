export default {
  ...
  statesData: [
    { state: 'Lagos', total: 4123, recovered: 745, death: 47 },
    { state: 'FCT', total: 535, recovered: 158, death: 14 },
    { state: 'Kano', total: 939, recovered: 139, death: 41 },
    { state: 'Ogun', total: 246, recovered: 128, death: 9 },
    { state: 'Osun', total: 44, recovered: 35, death: 4 },
    { state: 'Gombe', total: 154, recovered: 119, death: 3 },
    { state: 'Borno', total: 258, recovered: 160, death: 25 },
    { state: 'Katsina', total: 358, recovered: 51, death: 14 },
    { state: 'Edo', total: 240, recovered: 69, death: 13 },
    { state: 'Oyo', total: 260, recovered: 88, death: 6 },
    { state: 'Bauchi', total: 234, recovered: 205, death: 7 },
    { state: 'Kwara', total: 87, recovered: 37, death: 1 },
    { state: 'Akwa Ibom', total: 45, recovered: 14, death: 2 },
    { state: 'Kaduna', total: 221, recovered: 138, death:6 },
    { state: 'Ekiti', total: 20, recovered: 16, death: 2 },
    { state: 'Taraba', total: 18, recovered: 1, death: 0 },
    { state: 'Delta', total: 57, recovered: 14, death: 7 },
    { state: 'Ondo', total: 24, recovered: 19, death: 2 },
    { state: 'Rivers', total: 176, recovered: 43, death: 12 },
    { state: 'Enugu', total: 18, recovered: 8, death: 0 },
    { state: 'Niger', total: 30, recovered: 9, death: 1 },
    { state: 'Jigawa', total: 241, recovered: 78, death: 4 },
    { state: 'Zamfara', total: 76, recovered: 66, death: 5 },
    { state: 'Sokoto', total: 116, recovered: 93, death: 14 },
    { state: 'Abia', total: 10, recovered: 3, death: 0 },
    { state: 'Ebonyi', total: 40, recovered: 6, death: 0 },
    { state: 'Benue', total: 7, recovered: 1, death: 0 },
    { state: 'Anambra', total: 11, recovered: 3, death: 1 },
    { state: 'Plateau', total: 99, recovered: 47, death: 2 },
    { state: 'Adamawa', total: 38, recovered: 20, death: 3 },
    { state: 'Imo', total: 34, recovered: 7, death: 0 },
    { state: 'Yobe', total: 47, recovered: 8, death: 7 },
    { state: 'Nassarawa', total: 62, recovered: 18, death: 2 },
    { state: 'Kebbi', total: 33, recovered: 29, death: 4 },
    { state: 'Bayelsa', total: 12, recovered: 6, death: 1 },
    { state: 'Kogi', total: 2, recovered: 0, death: 0 }
  ],
  helplines: [
