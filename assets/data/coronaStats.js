export default {
  ...
  statesData: [
    { state: 'Lagos', total: 1667, recovered: 448, death: 33 },
    { state: 'FCT', total: 336, recovered: 40, death: 4 },
    { state: 'Kano', total: 547, recovered: 20, death: 18 },
    { state: 'Ogun', total: 113, recovered: 28, death: 4 },
    { state: 'Osun', total: 38, recovered: 30, death: 4 },
    { state: 'Gombe', total: 110, recovered: 10, death: 0 },
    { state: 'Borno', total: 142, recovered: 0, death: 14 },
    { state: 'Katsina', total: 137, recovered: 9, death: 8 },
    { state: 'Edo', total: 67, recovered: 12, death: 4 },
    { state: 'Oyo', total: 59, recovered: 14, death: 2 },
    { state: 'Bauchi', total: 117, recovered: 6, death: 1 },
    { state: 'Kwara', total: 24, recovered: 9, death: 1 },
    { state: 'Akwa Ibom', total: 17, recovered: 10, death: 2 },
    { state: 'Kaduna', total: 95, recovered: 14, death: 2 },
    { state: 'Ekiti', total: 12, recovered: 4, death: 1 },
    { state: 'Taraba', total: 15, recovered: 0, death: 0 },
    ...
    { state: 'Jigawa', total: 83, recovered: 0, death: 1 },
    { state: 'Zamfara', total: 65, recovered: 0, death: 3 },
    { state: 'Sokoto', total: 93, recovered: 4, death: 9 },
    ...
    { state: 'Kebbi', total: 18, recovered: 0, death: 0 },
